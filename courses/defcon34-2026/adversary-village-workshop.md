# Defcon 34 Adversary Village Cyberjutsu Workshop

Session schedule to be confirmed.
Adversary Village at DEF CON 34 is scheduled for August 7-9, 2026.
https://adversaryvillage.org/

## Abstract DEFCON34 Adversary Village
...
# Cyberjutsu Workshop
This year we will approach the concept of [Tsukuri](../../glossary.md#tsukuri); Tsukuri is the construction and preparation phase that creates the right conditions to reach your goal.
...
Call "mate" in the middle of each round for about 30 seconds to 1 minute to practice [Tsukuri](../../glossary.md#tsukuri), then resume the sequence.
