...
This folder contains Cyberjutsu kata derived from the training patterns already present in the repository.

Each kata is a formalized sequence built from recurring material in:
...
- [Kyojitsu no Kata](./kyojitsu-no-kata.md)
